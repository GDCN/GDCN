 ...
 */
public class ReplicaManagerOLD implements Serializable, Outdater, Cloneable{
...
//    private final Deque<ReplicaOLD> stagedReplicas = new ArrayDeque<>();
     ...
     */
    public ReplicaManagerOLD(int replicas) {
     ...
     */
    public ReplicaManagerOLD(int replicas, int expectedResults) {
        //TODO how long time?
     ...
     */
    public ReplicaManagerOLD(int replicas, int expectedResults, int calendarValue, int calendarField){
     ...
     */
    public ReplicaManagerOLD(int replicas, int expectedResults, int calendarValue, int calendarField, long updateInterval){
        if(replicas<1){
...
//                ReplicaOLD replica = new ReplicaOLD(task);
...
//        ReplicaOLD replica = new ReplicaOLD(oldReplica.getReplicaBox().getTaskMeta());
//
...
//        ReplicaOLD replica = assign.giveTask(workerReputation);
...
//        Stack<ReplicaOLD> skipped = null;
//        try{
//            ReplicaOLD replica = stagedReplicas.removeLast();
//
